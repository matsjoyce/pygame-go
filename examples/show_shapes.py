...
window.draw_ellipse(position=(300, 150), radii=(50, 100), color="gray")
window.draw_hollow_ellipse(position=(300, 150), radii=(50, 100), color="black", thickness=5)
...
window.draw_arc(start_angle=0, end_angle=90, radii=(75, 60), position=(100, 300), color="green", thickness=5)
window.draw_arc(start_angle=90, end_angle=180, radii=(75, 60), position=(100, 300), color="red", thickness=5)
window.draw_arc(start_angle=180, end_angle=270, radii=(75, 60), position=(100, 300), color="blue", thickness=5)
window.draw_arc(start_angle=270, end_angle=360, radii=(75, 60), position=(100, 300), color="black", thickness=5)
