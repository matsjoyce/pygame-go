...
class Color:
    def __init__(self, r, g, b, a=255):
        self._color = [put_in_range(i) for i in (r, g, b, a)]
    ...
    @r.setter
    def r(self, value):
        self._color[0] = put_in_range(value)
    ...
    @g.setter
    def g(self, value):
        self._color[1] = put_in_range(value)
    ...
    @b.setter
    def b(self, value):
        self._color[2] = put_in_range(value)
    ...
    def transparency(self, value):
        self._color[3] = put_in_range(value)
...
# Generated from pygame.colordict.THECOLORS
...
all_colors = {k: v for k, v in locals().items() if isinstance(v, Color)}
